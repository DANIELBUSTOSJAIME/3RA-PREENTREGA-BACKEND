...
import { postLogin, postSignUp, getCurrentUser, getGithubAuth, getGithubCallback, getGithubLoginCallback, getLogout } from "../controllers/session.controller.js";

const sessionRouter = Router()

sessionRouter.post('/login', passport.authenticate('login'), postLogin);
sessionRouter.post('/signUp', passport.authenticate('register'), postSignUp);
sessionRouter.get('/current', passportError('jwt'), authorization('admin'), getCurrentUser);
sessionRouter.get('/github', passport.authenticate('github', { scope: ['user:email'] }), getGithubAuth);
...
sessionRouter.get('/github-login/callback', passport.authenticate('github-login', { failureRedirect: '/login' }), getGithubLoginCallback);
